...
function Footer() {
  return (
    <div className=' px-10 pt-3 w-full h-[110vh] font-[Neue_Montreal]'>
      <div className='flex'>
        <div className='w-1/2 uppercase text-[5.5vw] leading-none tracking-tighter font-["Founders_Grotesk_X-condensed"]'>
        <h1>EYE-</h1>
        <h1>OPPENING</h1>
        </div>
        <div className='w-1/2 '><h1 className='uppercase text-[5.5vw] leading-none tracking-tighter font-["Founders_Grotesk_X-condensed"]'>presentations</h1>
        <div className='py-8 grid grid-cols-1 underline'>
           ...
           <div className='w-full grid grid-cols-2'>
             <div className='  underline grid grid-cols-1 leading-6.5'>
        ...
        <div className='grid grid-cols-1 underline leading-none'>
          ...
          <div className='py-10 grid grid-cols-1 underline'>
            <p className='mb-5 '>E:</p>
            <a href="">hello@ochi.design</a>
        </div>
        </div>
        </div>
      <div className='flex justify-between items-center mt-2 font-[Neue_Montreal] '>
        <div className=''>
        ...
        <div className='text-[#ffffff78]'>© ochi design 2025. <a className='underline' href=""> Legal Terms</a></div>
        <div className='text-[#ffffff78]'><a className='underline' href="">Website by Obys </a></div>
      </div>
    </div>
  )
}
